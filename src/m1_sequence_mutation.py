...
def run_test_zero_changer():
    ...
    # Test 2:
    test1 = ([8, 4, 0, 9], [77, 0, 0, 1, 5, 0], [4, 4, 4], [4, 1, 4])
    expected1 = ([8, 4, 1, 9], [77, 2, 3, 1, 5, 4], [4, 4, 4], [4, 1, 4])
    zero_changer(test1)
    print()
    print('Test 1:')
    print('  Expected:', expected1)
    ...
    # Test 3:
    test1 = ([8, 4, 1, 9], [77, 2, 3, 1, 5, 10], [4, 4, 4], [4, 1, 4])
    expected1 = ([8, 4, 1, 9], [77, 2, 3, 1, 5, 10], [4, 4, 4], [4, 1, 4])
    zero_changer(test1)
    print()
    print('Test 1:')
    print('  Expected:', expected1)
